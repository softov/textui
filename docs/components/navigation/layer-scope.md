...
The building block under [`Dialog`](dialog.md) and the menus. Reach for it when you need modal behaviour around something that is not a dialog - an inline editor that must keep the keyboard until it is finished, for instance.
