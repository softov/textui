...
Two small catalogues whose behaviour is documented elsewhere: these are the component names, and the links say where the model behind them lives.
...
What a surface is, and what a shell decides, is in [Platform](../platform/).
...
See [Documents](../documents/) and [Syntax highlighting](../themes/syntax.md).
