...
| --- | --- |
| [Store](store/index.md) | Paths, scopes, computed, collections, providers, events |
| [Components](components/index.md) | The catalog, and how to write one |
| [Themes](themes/index.md) | Tokens, glyphs, borders, capability downgrade, syntax |
| [Platform](platform/index.md) | Commands, keybindings, focus, layers, screens, extension points |
| [Terminal](terminal/index.md) | Adapters, capabilities, managed and embedded sessions |
| [Documents](documents/index.md) | Resource kinds, providers, viewers, editors, buffers |
| [CLI](cli/index.md) | The developer CLI and the registry model |
| [Testing](testing/index.md) | The harness, and what to assert |
