...
import { ToolCallRow } from '../src/index.js';
import type { ChatToolCall } from '../src/index.js';
...
async function open(call: Partial<ChatToolCall> = {}, props: Record<string, unknown> = {}) {
